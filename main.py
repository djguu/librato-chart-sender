...
class LibratoChartSender():
	...
	def run():
		...
		#...
		# rename html file !
		html_email_maker = HTMLEmailMaker("LCSHtml.html")
		email_body = html_email_maker.insert_snapshots(librato_shapshot_maker.run("3419"), librato_shapshot_maker.run("3420"))
